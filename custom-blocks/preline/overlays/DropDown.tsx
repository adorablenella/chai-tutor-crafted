...
const DropDown = ({ _trigger, _items, _show, blockProps }: any) => {
...
registerChaiBlock(DropDown, {
  ...
  props: {
    ...
    _trigger: Slot({ name: "Trigger", emptyStyles: "h-12" }),
    _items: Slot({ name: "Items", emptyStyles: "h-40" }),
  },
});
