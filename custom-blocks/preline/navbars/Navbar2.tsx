        ...
        <div
          ...
          <div className="mt-5 flex flex-col gap-x-0 gap-y-4 md:mt-0 md:flex-row md:items-center md:justify-end md:gap-x-7 md:gap-y-0 md:pl-7">
            ...
            <div className="hs-dropdown [--adaptive:none] [--strategy:static] md:py-4 md:[--strategy:fixed] md:[--trigger:hover]">
              ...
              <div className="hs-dropdown-menu duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 top-full z-10 hidden rounded-lg bg-white p-2 opacity-0 transition-[opacity,margin] before:absolute before:-top-5 before:left-0 before:h-5 before:w-full dark:divide-gray-700 dark:border-gray-700 dark:bg-gray-800 md:w-48 md:border md:shadow-md md:dark:border">
                <a
                ...
                <div className="hs-dropdown relative [--adaptive:none] [--strategy:static] md:[--trigger:hover] md:[--strategy:absolute]">
                  ...
                  <div className="hs-dropdown-menu duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 right-full top-0 z-10 !mx-[10px] hidden rounded-lg bg-white p-2 opacity-0 transition-[opacity,margin] before:absolute before:-right-5 before:top-0 before:h-full before:w-5 dark:divide-gray-700 dark:border-gray-700 dark:bg-gray-800 md:mt-2 md:w-48 md:border md:shadow-md md:dark:border">
                    <a
                      className="flex items-center gap-x-3.5 rounded-md px-3 py-2 text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                      href="#">
                      About
