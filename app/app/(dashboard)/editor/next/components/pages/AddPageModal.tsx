...
import { Dialog, DialogTrigger, DialogContent } from "../../../package/radix-ui";
import { TPageData, TPageSEOData } from "../../types";
import { Button, SelectOption, SingleLineText } from "../../../package";
...
const AddPageModalContent = ({ closeModal }: { closeModal: Function }): React.ReactElement => {
  ...
  const updateRealtime = ({ formData }, key?: string): void => {
